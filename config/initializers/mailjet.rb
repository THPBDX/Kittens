...
Mailjet.configure do |config|
 config.api_key = Rails.application.credentials.dig(:PUBLIC_KEY_MAIL)
 config.secret_key = Rails.application.credentials.dig(:SECRET_KEY_MAIL)
 config.default_from = 'haiden701@gmail.com'
